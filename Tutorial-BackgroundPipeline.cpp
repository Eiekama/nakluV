...
void Tutorial::BackgroundPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
    ...
    { // create pipeline
        ...
        // viewport and scissor state will be set at runtime
        ...
        // render to just one viewport and scissor rectangle
        VkPipelineViewportStateCreateInfo viewport_state{
            .sType = VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO,
            .viewportCount = 1,
            .scissorCount = 1,
        };
        // rasterizer will cull back faces and fill polygons
        ...
        // disable multisampling (so only 1 sample per pixel)
