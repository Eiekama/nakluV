...
struct Tutorial : RTG::Application {
	...
	struct LinesPipeline{
		...
		struct Camera { mat4 CLIP_FROM_WORLD; };
	...
	ObjectVertices klein_bottle_vertices;
	...
	struct OrbitCamera {
		...
		float radius = 14.0f; //distance from camera to target
		...
		float fov = 30.0f * M_PI/180.0f; //vertical field of view (radians)
